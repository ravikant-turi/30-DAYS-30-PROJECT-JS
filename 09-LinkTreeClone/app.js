...
function applyData(data) {
    ...
    //     console.log(nextlink.urlLink)
    //     innerCard.innerHTML = innerCard.innerHTML + 
    //     `<a id="linkUrl" class="link-div" href="${nextlink.urlLink}">
    //         <img src="${nextlink.icon}" alt="" class="logo">
    //         <h2 class="link-name">${nextlink.linkname}</h2>
    //     </a>`
    // });
